window.onload=function(){
	...
	function shijian(){
		...
		let future=new Date(2018,9,31);
		let box=shi.querySelectorAll(".shi .box");
		let arr=[];
		let time=Math.floor((future.getTime()-nowtime.getTime())/1000);
		...
		arr.push(second);
		box.forEach(function(elements,index){
			elements.innerText=arr[index];
		})
	}
	//
	//
	...
	sort1.onmouseenter=function(){
		img1.style.display="none";
		img2.style.display="block";
	}
	sort1.onmouseleave=function(){
		img1.style.display="block";
		img2.style.display="none";
	}
	sort2.onmouseenter=function(){
		img3.style.display="none";
		img4.style.display="block";
	}
	sort2.onmouseleave=function(){
		img3.style.display="block";
		img4.style.display="none";
	}
	sort3.onmouseenter=function(){
		img5.style.display="none";
		img6.style.display="block";
	}
	sort3.onmouseleave=function(){
	...
	backg.onclick=function(){
		let k=document.scrollTop||document.documentElement.scrollTop;
